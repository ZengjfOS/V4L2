/***************************************************** * 文件名：GetYuyv.c * 文件描述：linux下使用v4l2编程操作摄像头设备获取图片 * 编写人：王廷云 * 编写日期：2017-12-1 * 修改日期：2018-1-1 *****************************************************/ 
#include <stdio.h> 
#include <stdlib.h>
#include <unistd.h> 
#include <sys/types.h> 
...
#define FMT V4L2_PIX_FMT_XRGB32 // 图片格式 V4L2_PIX_FMT_YUYV
